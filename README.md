...
Ứng dụng tìm sân thể thao nhanh: React/Vinext ở frontend và FastAPI/Python ở
backend. Giao diện lọc khu vực, ngày, môn thể thao, giờ bắt đầu và hiển thị
khung giờ còn trống.
...
tách riêng tại `/api/upstream/branch/{branch_id}/schedule` và
`/api/upstream/branch/{branch_id}/bookings`; frontend mặc định dùng dữ liệu
cache mẫu để chạy ngay cả khi backend chưa khởi động.

## Included Shape

- edit site code under `app/`
- edit Python API under `backend/`
